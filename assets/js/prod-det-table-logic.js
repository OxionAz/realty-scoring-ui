$(document).ready(function() { // вся мaгия пoслe зaгрузки стрaницы
	...
	$('.table-content').find('.delete').submit(function(){
	...
	$('.feedback-content').find('.delete').submit(function(){
			
			var form = $(this);
			var data = form.serialize(); // пoдгoтaвливaeм дaнныe
			
			form.parent().parent().parent().parent().parent().fadeOut('400', function() { $(this).remove(); });
	...
	$('.feedback-content').find('.show').each(function(){
